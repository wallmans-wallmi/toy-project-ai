-- =============================================================================
-- Manual run (Supabase Dashboard → SQL) if you do not use supabase db push.
-- Same logic as supabase/migrations/20260510130000_donations_address_columns_sync.sql
-- =============================================================================
