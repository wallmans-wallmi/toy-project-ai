...
export function DonationOverviewTable({ rows, onUpdate, onQuickView, onExport }: DonationOverviewTableProps) {
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 lg:hidden">
        {rows.map((r) => (
          <article key={r.id} className="rounded-2xl border border-[#9333EA]/15 bg-white p-4 shadow-sm">
